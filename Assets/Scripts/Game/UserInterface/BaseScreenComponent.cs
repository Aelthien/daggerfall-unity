    ...
    public abstract class BaseScreenComponent : IDisposable
    {
        ...
        public virtual void Update()
        {
            ...
            else
            {
                ...
                mousePosition = new Vector2(0, 0);// InputManager.Instance.MousePosition.x, Screen.height - InputManager.Instance.MousePosition.y);
            }
            ...
            bool leftMouseDown = false;// InputManager.Instance.GetMouseButtonDown(0);
            bool rightMouseDown = false;// InputManager.Instance.GetMouseButtonDown(1);
            bool middleMouseDown = false;// InputManager.Instance.GetMouseButtonDown(2);

            // Get left and right mouse down for up/down events
            bool leftMouseHeldDown = false;// InputManager.Instance.GetMouseButton(0);
            bool rightMouseHeldDown = false;// InputManager.Instance.GetMouseButton(1);
            bool middleMouseHeldDown = false;// InputManager.Instance.GetMouseButton(2);
